  ...
  return (
    <>
      {!job ? (
        ...
        <div className="container bg-[#F3F4F6] min-h-screen dark:bg-[#1A1B1F] py-5 rounded-md mb-10 w-4/6 mt-10 mx-auto">
          <div
          ...
          >
            ...
            <table className="ml-6 relative flex-grow flex flex-col">
              ...
              <tr className=" lg:w-2/3 items-center">
                <td className="text-gray-500 min-w-24 font-medium">
                  Company:{" "}
                </td>
